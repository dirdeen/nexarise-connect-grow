...
export const CANDIDATES: Candidate[] = [
  {
    ...
    education: "Diploma in Business Administration, IPAM",
    ...
    workHistory: [
      "Reception Assistant, Bluecrest College",
      "Administrative Clerk, Rokel Commercial Bank",
    ],
  ...
  },
  {
    ...
    portfolio: "https://linkedin.com/in/mohamed-bangura",
    cvFile: "mohamed-bangura-cv.pdf",
    experience: "5 years field operations",
    education: "BSc Sociology, Njala University",
    ...
    workHistory: ["Enumerator, Statistics Sierra Leone", "Field Assistant, GIZ"],
  ...
  },
  {
    ...
    education: "BA Human Resource Management, Fourah Bay College",
    ...
    workHistory: ["Recruitment Officer, Orange SL", "HR Assistant, Africell"],
  ...
  },
  {
    ...
    portfolio: "https://linkedin.com/in/ibrahim-koroma",
    ...
    workHistory: ["Program Assistant, British Council", "Training Intern, UNDP"],
