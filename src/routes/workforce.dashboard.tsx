...
const readiness = [
  { label: "Identity verification", value: "Verified", icon: ShieldCheck, tone: "text-primary" },
  {
    label: "Training status",
    value: "Road safety complete",
    icon: ClipboardCheck,
    tone: "text-secondary",
  },
  { label: "Documents", value: "4 active files", icon: FileText, tone: "text-primary" },
  { label: "Rating", value: "4.9 / 5.0", icon: Star, tone: "text-secondary" },
];
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-0">
        <section className="rounded-3xl bg-gradient-hero p-8 text-white shadow-elegant">
          ...
          <div className="mt-5 grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              <h1 className="font-display text-3xl font-bold sm:text-4xl">Welcome back, Sorie</h1>
        ...
        <section className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <WorkforceStat label="Attendance" value="96%" />
          <WorkforceStat label="Earnings" value="NLe 4,500" tone="bg-primary/10 text-primary" />
          <WorkforceStat label="Completed" value="42 jobs" />
          <WorkforceStat
            label="Available"
        ...
        <div className="mt-8 grid gap-6 xl:grid-cols-2">
          ...
          <section>
            ...
            <div className="mt-4 grid gap-4">
              {[
                { label: "July attendance", value: "23 / 24 days", icon: CalendarCheck },
                { label: "On-time arrivals", value: "98%", icon: Timer },
                { label: "Employer earnings", value: "NLe 4,500 paid", icon: Banknote },
                {
                  label: "Verified workers nearby",
                  value: `${WORKERS.length} in network`,
                  icon: Users,
                },
              ].map((item) => (
                <div
